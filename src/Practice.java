...
public class Practice {
  ...
  // Time Complexity:O(n) n = number of ints in array
  ...
  // Time Complexity: (O n * c) n = num of arrays c = items in arrays
  // Space Complexity: O(1)
  // Remember to define your variables!
  ...
  // Time Complexity: O(n) n = T values in array
  ...
  public static int mostCommonSpaceEfficient(int[] nums) {
    ...
    // in O(1) space.
    // Basically rewriting the first method but with variables to keep track of best count, current count and what num incremented best count
